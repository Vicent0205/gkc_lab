...
HOST = '192.168.43.147' #destination ip
PORT = 7890 
...
app_id = "f03a16d7"
api_key = "8de29ac484027d29141358ba9fb59212"
...
def send_action(HOST, PORT, action):
    client = socket.socket(type=socket.SOCK_DGRAM)

    str_data = str(action) #第一个右轮，第二个左轮
